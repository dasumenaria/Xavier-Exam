        ...
        <div  style="padding-bottom:50px">
            <div class="form-group">
                ...
                <select class="form-control"  name="session" required="required"  style="background-color:#FFF !important">
                    ...
                    <?php
                        $set=mysql_query("Select * from `session` where `branch`='1' Order by `id` DESC");
                        while($fet=mysql_fetch_array($set))
                        {
                            $schl_id=$fet['id'];
                            $session=$fet['session'];$display_session=$fet['display_session'];
                            echo "<option selected value='".$session."'>".$display_session."</option>";
                        }
                    ?>
                </select>
            </div><br>
